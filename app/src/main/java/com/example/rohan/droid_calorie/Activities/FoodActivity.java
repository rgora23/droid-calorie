    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.food_activity_menu_button:
                startActivityForResult(new Intent(FoodActivity.this, FoodActivity.class), 0);
                return true;
            ...
            case R.id.macro_activity_menu_button:
                startActivityForResult(new Intent(FoodActivity.this, MacroActivity.class), 0);
                return true;

            case R.id.dash_activity_menu_button:
                startActivityForResult(new Intent(FoodActivity.this, DashActivity.class), 0);
                return true;

            case R.id.day_activity_menu_button:
                startActivityForResult(new Intent(FoodActivity.this, DayDetail.class), 0);
                return true;
